...
const INITIAL_SUBSCRIPTION_CHANNELS = 16;
const SUBSCRIPTION_CHANNEL_INCREMENT = 16;
...
const state = {
  ...
  localHistory: readArray("yt_history").filter((video) => video?.id),
